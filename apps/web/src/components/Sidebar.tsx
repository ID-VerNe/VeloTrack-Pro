...
export default function Sidebar() {
  ...
  const navSections: NavSection[] = [
    ...
    },
    {
      title: '骑行遥测',
      items: [
        { name: '活动档案库', icon: Layers, path: '/rides', badge: `${ridesCount}` },
      ...
      <aside className="w-60 bg-white border-r border-slate-200/80 p-5 flex flex-col justify-between shrink-0 h-full select-none shadow-xs">
        <div className="space-y-6">
          ...
          <NavLink to="/" className="flex items-center space-x-3 px-1 group">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-medium tracking-wide">科学骑行遥测与训练</p>
            </div>
          </NavLink>
                  ...
                  {section.items.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center space-x-2.5 min-w-0">
                            <Icon className="w-4 h-4 shrink-0 text-slate-400 group-hover:text-slate-900 transition-colors" />
                    ...
                    return (
                      ...
                      >
                        ...
                        {item.badge && (
                          <span
                            className={`text-[10px] font-bold px-1.5 py-0.2 rounded-md shrink-0 tabular-nums ${
        ...
        <div className="pt-4 border-t border-slate-100 space-y-2">
          <div 
            ...
            className="flex items-center justify-between p-2 rounded-2xl bg-slate-50 hover:bg-slate-100/90 border border-slate-200/70 transition-all cursor-pointer group shadow-xs active:scale-[0.98]"
