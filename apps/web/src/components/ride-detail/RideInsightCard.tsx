    ...
    <div className="pt-4 space-y-6">
      <div className="flex items-end justify-between border-b border-slate-100 pb-4">
        <div>
          ...
          <p className="text-[13px] text-slate-500 font-normal mt-1.5">
        ...
        <div className="flex items-center space-x-3">
          {isCached && !isLoading && (
            <span className="text-[12px] text-slate-400 px-2 py-0.5 font-mono">
              已存档
            </span>
          )}
          <button
      ...
      {isLoading ? (
        <div className="py-12 flex flex-col items-center justify-center space-y-3">
          ...
          <p className="text-[13px] text-slate-500">正在计算做功负荷与生物力学指标...</p>
        </div>
      ) : insight ? (
        <div className="markdown-body text-[14px] text-slate-700 leading-relaxed">
