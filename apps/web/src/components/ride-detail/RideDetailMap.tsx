...
export default function RideDetailMap({
  ...
  return (
    <div className="w-full h-full relative overflow-hidden bg-slate-100 min-w-0">
      ...
      <div className="absolute top-6 left-6 z-20 flex items-center space-x-1 bg-white/90 backdrop-blur p-1 rounded font-sans">
        {(
          [
            { id: 'light' as const, name: '常规' },
            { id: 'satellite' as const, name: '卫星' },
          ]
        ).map((item) => {
