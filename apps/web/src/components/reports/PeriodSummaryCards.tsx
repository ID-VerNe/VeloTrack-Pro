    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-100/80 shadow-2xs">
        <div className="flex items-center justify-between text-xs text-slate-500 font-bold mb-1.5">
          ...
          {summary.distance_change_pct !== 0 && (
            <span
              className={`flex items-center text-xs font-extrabold px-1.5 py-0.2 rounded-md ${
                summary.distance_change_pct > 0
        ...
        <div className="text-2xl font-black text-slate-900 tracking-tight tabular-nums flex items-baseline">
          ...
          <span className="text-xs font-semibold text-slate-500 ml-1">公里</span>
        </div>
      ...
      <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-100/80 shadow-2xs">
        <div className="flex items-center justify-between text-xs text-slate-500 font-bold mb-1.5">
          ...
          {summary.moving_ratio_pct && (
            <span className="text-xs font-extrabold bg-blue-50 text-blue-700 px-1.5 py-0.2 rounded-md">
      ...
      <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-100/80 shadow-2xs">
        ...
        <div className="text-2xl font-black text-slate-900 tracking-tight tabular-nums flex items-baseline">
          ...
          <span className="text-xs font-semibold text-slate-500 ml-1">km/h</span>
        </div>
      ...
      <div className="bg-slate-50/80 rounded-2xl p-4 border border-slate-100/80 shadow-2xs">
        ...
        <div className="text-2xl font-black text-slate-900 tracking-tight tabular-nums flex items-baseline">
          ...
          <span className="text-xs font-semibold text-slate-500 ml-1">米</span>
        </div>
        <div className="text-xs text-slate-500 mt-1 font-medium">
