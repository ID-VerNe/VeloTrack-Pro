    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-white rounded-lg p-5 border border-slate-200/80 space-y-2">
        ...
        <div className="text-2xl font-semibold font-mono text-slate-900 tracking-tight tabular-nums flex items-baseline">
          ...
          <span className="text-xs font-normal text-slate-500 ml-1 font-sans">公里</span>
        </div>
      ...
      <div className="bg-white rounded-lg p-5 border border-slate-200/80 space-y-2">
        ...
        <div className="text-2xl font-semibold font-mono text-slate-900 tracking-tight tabular-nums flex items-baseline">
          ...
          <span className="text-xs font-normal text-slate-500 ml-1 font-sans">km/h</span>
        </div>
      ...
      <div className="bg-white rounded-lg p-5 border border-slate-200/80 space-y-2">
        ...
        <div className="text-2xl font-semibold font-mono text-slate-900 tracking-tight tabular-nums flex items-baseline">
          ...
          <span className="text-xs font-normal text-slate-500 ml-1 font-sans">米</span>
        </div>
        <div className="text-[11px] text-slate-500 font-mono">
