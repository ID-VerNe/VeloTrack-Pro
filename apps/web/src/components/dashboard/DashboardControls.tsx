      ...
      <div className="flex items-center space-x-2">
        <div className="relative w-44 sm:w-56">
          ...
          <input
            ...
            data-1p-ignore="true"
            data-lpignore="true"
            className="w-full pl-8 pr-7 py-1.5 bg-white/95 backdrop-blur-md rounded text-base sm:text-xs font-normal text-slate-800 placeholder-slate-400 border border-slate-200/90 shadow-2xs focus:outline-none focus:border-slate-400 transition-colors"
          />
          {searchTerm && (
            <IconButton
              label="清空搜索词"
              ...
              >
                ...
                <span
                  className={`text-[10px] font-mono ml-0.5 px-1 py-0.2 rounded ${
                    isSelected ? 'bg-brand-700 text-brand-100' : 'bg-slate-100 text-slate-500'
                  }`}
                >
                  {city.count}
                </span>
